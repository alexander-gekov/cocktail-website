<div class="relative flex">
    ...
    @if(strlen($search) >= 2)
        <div class="absolute bg-gray-100 rounded w-full mt-12 mb-5">
                        ...
                        <li class="border-b border-gray">
                            <a href="#" class="block hover:bg-gray-300 px-3 py-3 flex items-center justify-between">
                                <div class="flex items-center">
                                    <img class="rounded-full" width="10%" src="img/{{$result["image"]}}" alt="">
                                    <div class="ml-4">{{$result["name"]}}</div>
                                    <div class="mx-2">‧</div>
                                    <div
                                        class="font-light text-gray-700 text-sm mr-4 flex-shrink-0"> {{$result["alcoholic"]}}</div>
                                </div>
                                <div class="flex justify-end">
                                    <div
                                        class="font-light text-sm tracking-wide bg-orange-400 rounded-full py-2 px-2 text-gray-900 mr-4 flex-shrink-0">{{$result["category"]}}</div>
                                </div>
                            </a>
                        </li>
                    @endforeach
