                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex flex-wrap">
                            <button type="submit" class="bg-blue-500 border border-blue-700 border-b-2 shadow-xl rounded-lg hover:bg-blue-600 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                {{ __('Register') }}
                            </button>
