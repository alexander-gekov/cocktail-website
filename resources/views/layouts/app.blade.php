...
<div id="app">
    <div class="flex h-screen overflow-y-hidden">
        <div
            ...
            <a href="/home" class="py-6 px-5 hover:text-orange-500 hover:bg-gray-100"><i
                    class="far fa-compass mr-5"></i>
                Explore</a>
            ...
            <a href="https://github.com/alexander-gekov"
               class="py-6 px-5 text-sm hover:text-orange-500 hover:bg-gray-100"><i
                    class="fab fa-github mr-5"></i> GitHub</a>
            <a href="https://www.instagram.com/alexander.gekov/"
               class="py-6 px-5 text-sm hover:text-orange-500 hover:bg-gray-100"><i
                    class="fab fa-instagram mr-5"></i> Instagram</a>
            <a href="https://www.linkedin.com/in/aleksandar-gekov-b43ba919a/"
               class="py-6 px-5 text-sm hover:text-orange-500 hover:bg-gray-100"><i
